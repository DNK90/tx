...
export interface Transaction {
  ...
  [TransactionType.Sponsored]: SponsoredTransaction
}
...
export function isSponsoredTx(tx: TypedTransaction): tx is BlobEIP4844Transaction {
  return tx.type === TransactionType.Sponsored
}
...
export interface TransactionInterface<T extends TransactionType = TransactionType> {
  ...
  readonly payerV?: bigint
  readonly payerR?: bigint
  readonly payerS?: bigint
  readonly expiredTime?: bigint
  readonly payerUrl?: string
...
export interface TxData {
  ...
  [TransactionType.Sponsored]: SponsoredTransactionData
}
...
export function isSponsoredTxData(txData: TypedTxData): txData is SponsoredTransactionData {
  const txType = Number(bytesToBigInt(toBytes(txData.type)))
  return txType === TransactionType.Sponsored
}
...
/**
 * {@link SponsoredTransaction} data.
 */
export interface SponsoredTransactionData extends LegacyTxData {
  chainId?: BigIntLike
  maxPriorityFeePerGas?: BigIntLike
  maxFeePerGas?: BigIntLike
  payerR?: BigIntLike
...
export interface TxValuesArray {
  ...
  [TransactionType.Sponsored]: SponsoredTxValuesArray
}
